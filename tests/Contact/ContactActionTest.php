...
class ContactActionTest extends ActionTestCase
{
    ...
    {
        $this->renderer->expects($this->once())->method('render')->with('@contact/contact')->willReturn('');
    ...
    public function testPostInvalid()
    {
        ...
        $this->renderer->expects($this->once())->method('render')->with(
            '@contact/contact',
            $this->callback(
                function ($params) {
    ...
    public function testPostValid()
    {
        ...
        $this->renderer->expects($this->any())->method('render')->willReturn('tetexttextxt', 'htmhtmlhtmll');
